...
//TLE根数参数信息解析模块
int DecomposeTleParameter(char line1[], char line2[],
	double* mjd, double* ele_kpl, double* ha, double* hp, double* incl, double* period);
	//输入:
	//		line1[]			: 字符串,TLE根数第一行
	//		line2[]			: 字符串,TLE根数第二行
	//输出:
	//		mjd				: 浮点数,TLE根数历元(约简儒略日,UTC)
	//		ele_kpl[0..5]	: 六维浮点型数组,kepler六根数.
	//			ele_kpl[0],半长轴[米]
	//			ele_kpl[1],偏心率[无量纲]
	//			ele_kpl[2],轨道倾角[弧度]
	//			ele_kpl[3],升交点赤经[弧度]
